...
// catalog
  ...
  getIt.registerLazySingleton(() => AddStockRemoteDataSource(getIt()));
  getIt.registerLazySingleton(() => AddStockRepo(getIt()));
  getIt.registerFactory(() => AddStockCubit(getIt())); // Orders
}
