...
mixin _$Category {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, id, name, image, imageUrl,
      const DeepCollectionEquality().hash(media), createdAt, updatedAt);

  @override
  String toString() {
    return 'Category(id: $id, name: $name, image: $image, imageUrl: $imageUrl, media: $media, createdAt: $createdAt, updatedAt: $updatedAt)';
  }
}
...
extension CategoryPatterns on Category {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _Category() when $default != null:
        return $default(_that.id, _that.name, _that.image, _that.imageUrl,
            _that.media, _that.createdAt, _that.updatedAt);
      case _:
        return orElse();
    }
  }
...
class _Category implements Category {
  const _Category(
      ...
      required final List<dynamic> media,
  ...
  @override
  int get hashCode => Object.hash(runtimeType, id, name, image, imageUrl,
      const DeepCollectionEquality().hash(_media), createdAt, updatedAt);
