...
import 'ui_create_order_state.dart';

class UiCreateOrderCubit extends Cubit<UiCreateOrderState> {
  UiCreateOrderCubit() : super(const UiCreateOrderState());
