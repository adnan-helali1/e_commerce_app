...
extension CatalogStatePatterns on CatalogState {
  ...
  TResult maybeWhen<TResult extends Object?>({
    ...
    TResult Function(CatalogResponse response)? success,
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(CatalogResponse response) success,
...
class _Initial implements CatalogState {
  const _Initial();
...
class _Success implements CatalogState {
  ...
  @override
  String toString() {
    return 'CatalogState.success(response: $response)';
  }
}
...
abstract mixin class _$SuccessCopyWith<$Res>
  ...
  @useResult
  $Res call({CatalogResponse response});
...
class _Failure implements CatalogState {
  ...
  @override
  String toString() {
    return 'CatalogState.failure(error: $error)';
  }
}
