...
mixin _$LedgerState {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is LedgerState);
  }
...
/// @nodoc
class $LedgerStateCopyWith<$Res> {
  $LedgerStateCopyWith(LedgerState _, $Res Function(LedgerState) __);
}

/// Adds pattern-matching-related methods to [LedgerState].
extension LedgerStatePatterns on LedgerState {
...
class _Initial implements LedgerState {
  const _Initial();
...
class _Loading implements LedgerState {
  const _Loading();
...
class __$SuccessCopyWithImpl<$Res> implements _$SuccessCopyWith<$Res> {
  ...
  @pragma('vm:prefer-inline')
  $LedgerResponseCopyWith<$Res> get response {
    return $LedgerResponseCopyWith<$Res>(_self.response, (value) {
...
class _Failure implements LedgerState {
  ...
  @override
  String toString() {
    return 'LedgerState.failure(error: $error)';
  }
}
